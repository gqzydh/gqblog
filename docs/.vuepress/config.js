...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'gqzydh/gqblog', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'Garen', // 必需
      link: 'https://github.com/gqzydh' // 可选的
    },
    blogger:{ // 博主信息，显示在首页侧边栏
      avatar: '/gqblog/img/tx.jpg',
      name: 'Garen',
      slogan: '前端小菜鸡(✪ω✪)'
    },
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'Garen | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
    htmlModules
  },
  plugins: [ // 插件
    ...
    [
      ...
      // },
      {
        ...
        options: {
          ...
          repo: 'gqblog', // GitHub 仓库
          owner: 'gqzydh', // GitHub仓库所有者
          admin: ['gqzydh'], // 对仓库有写权限的人
